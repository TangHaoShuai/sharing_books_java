...
import com.haoshuai.accountbook.entity.model.ArticleModel;
import com.haoshuai.accountbook.entity.model.CommentModel;
...
//            ImgList
            ...
            if (imgLists != null && imgLists.size() > 0) {
                ...
                for (ImgList imgL : imgLists) {
                    String path = Util.ARTICLE_IMG + imgL.getImgUrl();
